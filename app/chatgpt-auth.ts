...
const CLOUDFLARE_ACCESS_ID_HEADER = "cf-access-authenticated-user-uuid";
...
export async function getChatGPTUser(): Promise<ChatGPTUser | null> {
  ...
  const userId =
    ...
    requestHeaders.get(CLOUDFLARE_ACCESS_ID_HEADER) ??
    email;
...
export function authenticatedEmailFromHeaders(
